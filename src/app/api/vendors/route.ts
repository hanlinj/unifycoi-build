...
// contains exactly the vendors "Total vendors" counts. No filters, no pagination — a filter bar
// was built and then reverted (UI/interaction problems), not carried forward here.
